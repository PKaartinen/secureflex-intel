...
export function getStatusColor(status: string): string {
  ...
  if (s === 'negotiation') return 'bg-purple-500/20 text-purple-400 border-purple-500/30'
  if (s === 'proposal') return 'bg-indigo-500/20 text-indigo-400 border-indigo-500/30'
  if (s === 'engaged') return 'bg-blue-500/20 text-blue-400 border-blue-500/30'
  if (s === 'outreach') return 'bg-amber-500/20 text-amber-400 border-amber-500/30'
  if (s === 'research') return 'bg-gray-500/20 text-gray-400 border-gray-500/30'
  // Legacy fallbacks
